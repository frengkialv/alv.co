...
# Env Vars
NEXT_PUBLIC_BASE_URL=https://alvco-be.my.id
DOMAIN_NAME="alvco.my.id" # replace with your own
EMAIL="and.frengky@gmail.com" # replace with your own

# Script Vars
REPO_URL="https://github.com/frengkialv/alv.co.git"
APP_DIR=~/myapp
...
echo "NEXT_PUBLIC_BASE_URL=$NEXT_PUBLIC_BASE_URL" > "$APP_DIR/.env"
